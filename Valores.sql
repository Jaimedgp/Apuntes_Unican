...
insert into USUARIO (idUsuario, nombre , apellido1 , apellido2       , password                          , nick       , email                       )
             values (1        , 'David', 'Iglesias', 'Sánchez'       , '451d8bb9214d5cf16d1f22e5cbeb0ad2', 'Pelu'     , 'davidiglesanchez@gmail.com'),
                    (2        , 'Jaime', 'Díez'    , 'González-Pardo', '81dc9bdb52d04dc20036dbd8313ed055', 'Jaimedgp' , 'jaimediez@gmail.com'       ),
                    (7        , 'David', 'Iglesias', 'Sonchez'       , '451d8bb9214d5cf16d1f22e5cbeb0ad2', 'davidigle', 'davidiglesonchez@gmail.com'),
                    (8        , 'David', 'Iglesias', 'Sánchiz'       , '451d8bb9214d5cf16d1f22e5cbeb0ad2', 'david'    , 'davidiglesanchiz@gmail.com')
;
...
insert into DOCUMENTOS (idDocumento, titulo                           , usuario, fechaSubida          , tipo, anio, documento            , hash                 , comentario                       , asignatura, puntuacion)
                values (2          , 'Examen Parcial Inexistente'     , 1      , '2017-04-05 14:59:09', 1   , 3   , 'examenparcial.pdf'  , '832rn0xyrqx8yfn08'  , 'Examen parcial del año la polka', 2         , 1         ),
                       (3          , 'No es lo mismo montar un follón', 1      , '2017-04-06 23:42:54', 0   , 3   , 'noes.pdf'           , '832rn0xyrqx8yfn09'  , 'Libro sobre cosas'              , 3         , 2         ),
                       (4          , 'Electromagnetismo inutil'       , 1      , '2017-04-06 23:43:27', 0   , 3   , 'no2es.pdf'          , '238nx073rnw8'       , 'Tengo cien de estos'            , 2         , 3         ),
                       (80         , 'Electromagnetismo jodido'       , 2      , '2017-04-15 17:20:20', 0   , 5   , 'documentoFalso.pdf' , '238nx073rnw7'       , 'Electromagnetismo del jodido ' 
                                                                                                                                                                   ', pero jodido de verdad'       , 2         , 7         )
;